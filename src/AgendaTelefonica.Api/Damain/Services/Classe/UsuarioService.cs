...
namespace AgendaTelefonica.Api.Damain.Services.Classe
{
    public class UsuarioService : IUsuarioService
    {
        ...
        {
            UsuarioResponseContrato usuario = await ObterPorNumero(usuarioLoginRequestContrato.Telefone);
        ...
        public async Task<UsuarioResponseContrato> ObterPorNumero(string telefone)
        {
            var usuario = await _usuarioRepository.ObterPorTelefone(telefone);
            return _mapper.Map<UsuarioResponseContrato>(usuario);
        }
    }
}